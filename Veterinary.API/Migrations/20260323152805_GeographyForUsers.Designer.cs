...
namespace Veterinary.API.Migrations
{
    ...
    [Migration("20260323152805_GeographyForUsers")]
    partial class GeographyForUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Veterinary.Shared.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Veterinary.Shared.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Veterinary.Shared.Entities.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Veterinary.Shared.Entities.City", b =>
                {
                    b.HasOne("Veterinary.Shared.Entities.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Veterinary.Shared.Entities.State", b =>
                {
                    b.HasOne("Veterinary.Shared.Entities.Country", "Country")
                        .WithMany("States")
            ...
            modelBuilder.Entity("Veterinary.Shared.Entities.User", b =>
                {
                    b.HasOne("Veterinary.Shared.Entities.City", "City")
                        .WithMany("Users")
